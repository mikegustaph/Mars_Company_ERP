                        ...
                        <tbody>
                            ...
                            @foreach ($policies as $row)
                                <tr>
                                   ...
                                   <!-- onclick="openPdf('')" -->
                                    <td>
                                        <a href="{{ Storage::url('public/files/'.$row->file)}}" class="btn btn-default btn-sm btn-icon icon-left" target="_blank">
               ...
               <div class="row">
                <div class="col-md-12" style="padding:43px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="policy_name" class="form-control" id="field-1" placeholder="Policy Name">
                    </div>
                    <div class="form-group">
