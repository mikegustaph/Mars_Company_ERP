                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" value="{{ $service->duedate }}" name="duedate"
                                        class="form-control" id="field-1" placeholder="Enter due date Eg: 12">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" value="{{ $service->kpi_receive_target_day }}"
                                        name="kpi_receive_target_day" class="form-control" id="field-1" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-5 control-label"> Early Points </label>
                                <div class="col-sm-3">
                                    <input type="text" value="{{ $service->kpi_receive_early_points }}"
                                        name="kpi_receive_early_points" class="form-control" id="field-1" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="field-1" class="col-sm-5 control-label"> Late Points </label>
                                <div class="col-sm-3">
                                    <input type="text" value="{{ $service->kpi_receive_late_points }}"
                                        name="kpi_receive_late_points" class="form-control" id="field-1"
                                        placeholder="">
                                </div>
                            </div>
                        </div>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            $('#addrowbtn').click(function() {
                                ...
                                var typeRow = $('<select>').addClass('.selectboxit').append(
